...
import { Icon, Text, Popover, Placeholder, PlaceholderParagraph, Dropdown } from '@innovaccer/design-system'
  ...
  return class SuggestionComponent extends Component {
    ...
    onEditorKeyDown = event => {
      ...
      if (event.key === 'ArrowDown') {
        ...
        if (activeOption === this.filteredSuggestions.options.length - 1) {
        ...
        if (activeOption <= 0) {
          newState.activeOption = this.filteredSuggestions.options.length - 1;
        } else {
          newState.activeOption = Number(activeOption) - 1;
        }
          ...
          {showSuggestions && (
            ...
            >
              <Dropdown
                ...
                onChange={(e) => this.addMention(e)}
                // onUpdate={(e) => this.addMention(e)}
